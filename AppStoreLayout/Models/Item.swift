...
enum Item: Hashable {
    ...
    static let promotedApps: [Item] = [
        .app(App(promotedHeadline: "Now Trending", title: "Half Life VR", subtitle: "Game Description", price: 3.99)),
        .app(App(promotedHeadline: "Limited Time", title: "Call fo Duty 87", subtitle: "Game Description", price: nil)),
        .app(App(promotedHeadline: "New Update", title: "Final Fantasy X-3", subtitle: "Game Description", price: nil)),
        .app(App(promotedHeadline: "Just Released", title: "The Lsst of Us", subtitle: "Game Description", price: nil))
    ]
